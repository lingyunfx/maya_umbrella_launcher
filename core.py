...
from github_utils import get_latest_release, download_release_files
from filesystem import (create_folder_if_not_exist, extract_zip, validate_folder_exist,
...
def set_setting(kay, value):
    """
    设置设置
    """
    setting = QtCore.QSettings(const.SETTING_FLAG)
    setting.setValue(kay, value)
